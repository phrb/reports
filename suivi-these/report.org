...
We identified  four other potential  DoE techniques, described in  the following
paragraphs: a modification  of screening that allows factors with  more than two
levels; /contractive replacement/, that generates mixed-level designs from 2-level
ones; a  /direct generation/ algorithm  for the construction of  small multi-level
designs; and D-Optimal designs, a  flexible construction technique that we ended
up choosing for our approach.
